...
+ [建立跨通道視覺化](/help/creating-cross-channel-visualizations-in-customer-journey-analytics.md)
+ [跨通道歸因](/help/cross-channel-attribution-in-customer-journey-analytics.md)
+ [客戶歷程分析中的計算量度簡介](/help/introduction-to-calculated-metrics-in-customer-journey-analytics.md)
+ [將計算量度從Adobe Analytics移至客戶歷程分析](/help/moving-your-calculated-metrics-from-adobe-analytics-to-customer-journey-analytics.md)
+ [濾鏡簡介](/help/introduction-to-filters-in-cja.md)
+ [建立跨通道篩選](/help/creating-cross-channel-filters-in-customer-journey-analytics.md)
+ [將Adobe Analytics細分移至客戶歷程分析](/help/moving-adobe-analytics-segments-to-customer-journey-analytics.md)