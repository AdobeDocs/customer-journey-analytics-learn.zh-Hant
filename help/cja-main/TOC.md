...
+ 遠端MCP伺服器 {#remote-mcp-server}
  + [CJA的遠端MCP伺服器概述](remote-mcp-server/remote-mcp-server-for-cja-overview.md)
  + [CJA的遠端MCP伺服器正在執行中](remote-mcp-server/remote-mcp-server-for-cja-in-action.md)
+ 架構 {#architecture}
...
+ 資料準備與規劃 {#data-prep}
  ...
  + [攝取和使用 Adobe Analytics 分類資料](data-prep/ingest-and-use-analytics-classifications.md)
+ 存取控制 {#access-control}
...
+ 連線 {#connections}
  ...
  + [開始使用對象分析](connections/get-started-with-audience-analysis.md)
+ 訪客身分識別 {#visitor-id}
  + [了解 CJA 如何使用身分識別](visitor-id/understanding-how-customer-journey-analytics-uses-identity.md)
  + [拼接概觀](visitor-id/overview-of-stitching.md)
  + [使用預覽驗證資料和銜接品質](visitor-id/validate-identity-stitching-quality.md)
  + [拼接啟用和驗證](visitor-id/stitching-enablement-and-validation.md)
...
+ 資料視圖 {#data-views}
  ...
  + [建立摘要層級資料來源](data-views/create-summary-level-data-sources.md)
  ...
  + 衍生欄位{#derived-fields}
    ...
    + [使用數學函數](data-views/derived-fields/use-the-math-function-in-derived-fields.md)
    + [使用下一個或上一個函數](data-views/derived-fields/use-the-next-previous-function-in-derived-fields.md)
    + [自訂事件深度](data-views/derived-fields/customize-event-depth-in-derived-fields.md)
    + [使用類型轉換](data-views/derived-fields/use-typecasting-in-derived-fields.md)
...
+ Data Insights 代理 {#data-insights-agent}
  ...
  + [與Microsoft 365 Copilot整合](data-insights-agent/data-insights-with-marketing-agent-365copilot.md)
+ Analysis Workspace {#analysis-workspace}
  + Workspace 專案 {#workspace-projects}
    ...
    + [Analysis Workspace 範本](analysis-workspace/workspace-projects/analysis-workspace-templates.md)
    + [Workspace 評論](analysis-workspace/workspace-projects/workspace-commenting.md)
    + 歷程分析 {#journey-analysis}
      + [歷程版面視覺效果](analysis-workspace/workspace-projects/journey-analysis/journey-canvas-viz.md)
  + 面板 {#panels}
    + [將元件新增至自由格式面板](analysis-workspace/panels/add-components-to-the-freeform-panel.md)
    + [建置歸因面板](analysis-workspace/panels/build-the-attribution-panel.md)
  ...
  + 自由格式表格 {#freeform-tables}
    ...
    + [探索自由格式表格中的列和欄設定](analysis-workspace/freeform-tables/cja-explore-row-and-column-settings-in-freeform-tables.md)
  + 視覺效果 {#visualizations}
    ...
    + [Dimension-Graph即時連結](analysis-workspace/visualizations/dimension-graph-live-linking.md)
    + [建立智慧型註解](analysis-workspace/visualizations/intelligent-captions.md)
    + [表格和視覺效果資料來源設定](analysis-workspace/visualizations/cja-configure-table-and-visualization-data-source-settings.md)
    ...
    + [新增趨勢線條為線條視覺效果](analysis-workspace/visualizations/cja-add-trendlines-to-line-visualizations.md)
    + [使用累積平均函式進行量度平滑處理](analysis-workspace/visualizations/cja-use-the-cumulative-average-function-for-metric-smoothing.md)
    ...
    + [自訂視覺效果圖例](analysis-workspace/visualizations/cja-customize-visualization-legends.md)
    + [設定視覺效果的粒度](analysis-workspace/visualizations/cja-set-granularity-for-visualizations.md)
...
+ 引導式分析 {#guided-analysis}
  + [在 Workspace 中使用引導式分析](guided-analysis/guided-analysis-in-workspace.md)
...
+ Content Analytics {#content-analytics}
  ...
  + [報告](content-analytics/reporting.md)
+ 儀表板 (計分卡) {#dashboards}
...
+ 報告活動管理員 {#reporting-activity-manager}
  + [使用報告活動管理員](reporting-activity-manager/use-the-reporting-activity-manager.md)
+ Experience Platform 整合 {#experience-platform-integration}
  + [Adobe Journey Optimizer 的增強報告功能](experience-platform-integration/enhanced-reporting-for-adobe-journey-optimizer.md)
+ 使用案例 {#use-cases}
  + 人工智慧 {#ai}
    + [追蹤和分析 AI 流量](use-cases/ai/track-and-analyze-ai-traffic.md)
    + [使用Data Engineering Agent驗證資料集品質](use-cases/ai/validate-dataset-quality-data-engineering-agent.md)
  + 資料視圖使用案例 {#data-views-use-cases}
