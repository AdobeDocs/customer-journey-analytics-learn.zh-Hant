---
title: 將[!UICONTROL 環形圖]視覺效果新增至 [!DNL Analysis Workspace] 專案
...
如需[!UICONTROL 環形圖]視覺效果的詳細資訊，請瀏覽[檔案](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/visualizations/donut.html){target="_blank"}。
