---
title: 設定和使用地圖視覺效果
description: 利用地圖視覺化功能，生動呈現您的位置資料！ 確認地理群集，並使用選取工具建立即時區段。 只要幾個簡單的設定步驟，您就可以開始了！
...
利用地圖視覺化功能，生動呈現您的位置資料！ 確認地理群集，並使用選取工具建立即時區段。 只要幾個簡單的設定步驟，您就可以開始了！ 如需詳細資訊，請查看[文件](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/map){target="_blank"}。
