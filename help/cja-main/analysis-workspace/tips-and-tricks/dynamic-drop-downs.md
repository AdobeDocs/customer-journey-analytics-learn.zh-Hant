...
瞭解如何根據整個維度建立下拉式區段。 Dimension專案會根據報告面板中使用的日期範圍動態更新。 如需詳細資訊，請瀏覽本[文件](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-components/cja-segments/create-filters){target="_blank"}。
