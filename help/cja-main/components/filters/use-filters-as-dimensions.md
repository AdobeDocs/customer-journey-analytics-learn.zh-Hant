...
瞭解在Analysis Workspace專案中做為維度使用時，如何比較和視覺化區段。 如需詳細資訊，請瀏覽本[文件](https://experienceleague.adobe.com/zh-hant/docs/analytics-platform/using/cja-components/cja-segments/create-filters){target="_blank"}。
