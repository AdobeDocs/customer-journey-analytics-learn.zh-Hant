---
title: Content Analytics 簡介
description: 衡量內容績效相當困難，通常都是憑藉猜測而且效率不彰。 Content Analytics 提供深入的洞察分析，說明如何讓內容發揮效用，省去猜測的麻煩。
feature: Use Cases
role: Leader, User
level: Beginner
duration: 650
...
# Content Analytics 簡介

衡量內容績效相當困難，通常都是憑藉猜測而且效率不彰。 Content Analytics 提供深入的洞察分析，說明如何從調性、影像、顏色或訊息內容讓內容發揮效用，省去猜測的麻煩。 其可以回答關鍵問題，例如哪些因素會提高參與度，以及如何將內容最佳化。

如需詳細資訊，請審閱 Content Analytics [文件](https://experienceleague.adobe.com/zh-hant/docs/analytics-platform/using/content-analytics/content-analytics){target="_blank"}。
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="how-it-works.md" target="_blank" rel="referrer" title="Content Analytics - 如何運作">Content Analytics - 如何運作</a>
                    </p>
                    <p class="is-size-6">了解 Content Analytics 如何搭配 Customer Journey Analytics 和 Experience Platform 使用。</p>
                </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">了解如何使用 Content Analytics 引導式工作流程。 它能簡化行銷人員的設定流程，於 Customer Journey Analytics 內達到高效率的資料收集、處理和報告。 </p>
                </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">藉由調整名稱、資料視圖和體驗擷取設定，有效率地編輯 Content Analytics 設定。 此動作能自動更新量度，並透過 Content Analytics 標記擴充功能執行微調，讓洞察達到最佳化。</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Content Analytics - Reporting">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="reporting.md" target="_blank" rel="referrer" title="Content Analytics - 報告">Content Analytics - 報告</a>
                    </p>
                    <p class="is-size-6">了解 Content Analytics 如何提供網站內容績效的詳細報告。</p>
                </div>
